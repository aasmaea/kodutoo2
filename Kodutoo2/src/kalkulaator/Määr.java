 ...
 * 
 *         Neivelt - http://uudised.err.ee/v/arvamus/00b94117-fadb-47b7-beae-6f
 *         eaad321b8c IRL -
 *         http://arileht.delfi.ee/news/uudised/vaata-tabelist-kui
 *         -suur-oleks-sinu
 *         -palk-irl-i-pakutud-tulumaksuvabastusega.d?id=69603445 Keskerakond -
 *         http://uudised.err.ee/v/majandus/4a3dce34-8fe1-406f-b7e9-31ad5cfc392b
 *         Sotsiaaldemokraadid - http://blogid.sotsdem.ee/rahandus/
 *         Reformierakond
 *         -http://www.reform.ee/kindlalt-edasi/?utm_source=re&utm_medium
 *         =banner&utm_campaign=kindlalt_edasi 2014. maksusüsteem -
 *         http://www.emta.ee/index.php?id=34957 2015. maksusüsteem -
 *         http://www.emta.ee/index.php?id=35954
 *
 */
public class Määr {
	...
	public static final String[] valimised = { "Neiveltit", "IRL-i",
			...
			"2014. maksusüsteemi", "2015. maksusüsteemi" };
	...
	public static final double[] tttkmm = { (double) 0.016, (double) 0.016,
			(double) 0.016, (double) 0.016, (double) 0.016, (double) 0.02,
			(double) 0.016 };
